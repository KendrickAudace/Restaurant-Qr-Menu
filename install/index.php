                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/cache/', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/pwa/', 'uploads/store_logos/', 'uploads/store_images/', 'uploads/store_opengraph/', 'uploads/store_favicons/', 'uploads/menu_images/', 'uploads/item_images/'] as $key): ?>
                                        <tr>
                                            <td>/<?= $key ?></td>
