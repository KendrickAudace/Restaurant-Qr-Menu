...
<div class="mb-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted font-weight-bold"><?= l('admin_stores.menu') ?></small>
                <div class="mt-2"><span class="h4"><?= nr($data->stores) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->stores_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/stores') ?>" class="stretched-link">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-store text-primary"></i>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted font-weight-bold"><?= l('admin_index.orders') ?></small>
                <div class="mt-2"><span class="h4"><?= nr($data->orders) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->orders_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/stores') ?>" class="stretched-link">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-bell text-primary"></i>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted font-weight-bold"><?= l('admin_index.menus') ?></small>
                <div class="mt-2"><span class="h4"><?= nr($data->menus) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->menus_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/stores') ?>" class="stretched-link">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-list text-primary"></i>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted font-weight-bold"><?= l('admin_index.items') ?></small>
                <div class="mt-2"><span class="h4"><?= nr($data->items) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->items_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/stores') ?>" class="stretched-link">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-burn text-primary"></i>
                    </span>
                </a>
            </div>
        </div>
