        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stores_limit" name="stores_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->stores_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="menus_limit" name="menus_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->menus_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="categories_limit"><?= l('admin_plans.plan.categories_limit') ?></label>
                    <input type="number" id="categories_limit" name="categories_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->categories_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="items_limit"><?= l('admin_plans.plan.items_limit') ?></label>
                    <input type="number" id="items_limit" name="items_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->items_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="ordering_is_enabled" name="ordering_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->ordering_is_enabled ? 'checked="checked"' : null ?>>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="online_payments_is_enabled" name="online_payments_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->online_payments_is_enabled ? 'checked="checked"' : null ?>>
