...
<div class="my-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-store mr-1"></i> <?= l('admin_stores.menu') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->stores) ?></span></div>
            </div>

            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/stores?user_id=' . $data->user->user_id) ?>" class="stretched-link">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-bell mr-1"></i> <?= l('admin_user_view.orders') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->orders) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-list mr-1"></i> <?= l('admin_user_view.menus') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->menus) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-shopping-bag mr-1"></i> <?= l('admin_user_view.categories') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->categories) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted"><i class="fas fa-fw fa-sm fa-burn mr-1"></i> <?= l('admin_user_view.items') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->items) ?></span></div>
            </div>
        </div>
    </div>
