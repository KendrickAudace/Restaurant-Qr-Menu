...
<section class="admin-sidebar">
    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminStores']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/stores') ?>">
                    <i class="fas fa-fw fa-sm fa-store mr-2"></i> <?= l('admin_stores.menu') ?>
                </a>
            </li>
