...
<div style="position: fixed; right: 1rem; bottom: 1rem; z-index: 1;">
    <div class="mb-2">
        <button type="button" class="btn btn-light" onclick="document.querySelector('h1').scrollIntoView({ behavior: 'smooth', block: 'center' });" data-toggle="tooltip" data-placement="left" title="<?= l('global.scroll_top') ?>">
            <i class="fas fa-fw fa-arrow-up"></i>
        </button>
    </div>
    <div>
        <button type="button" class="btn btn-light" onclick="document.querySelector(`button[type='submit']`).scrollIntoView({ behavior: 'smooth', block: 'center' });" data-toggle="tooltip" data-placement="left" title="<?= l('global.scroll_bottom') ?>">
