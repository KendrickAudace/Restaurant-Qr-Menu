            ...
            <div class="card pricing-card h-100" style="<?= settings()->plan_free->color ? 'border-top-color: ' . settings()->plan_free->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3 text-center">
                        <span class="font-weight-bold text-black text-uppercase"><?= settings()->plan_free->translations->{\Altum\Language::$name}->name ?: settings()->plan_free->name ?></span>
                    </div>
        ...
        >
            <div class="card pricing-card h-100" style="<?= $plan->color ? 'border-top-color: ' . $plan->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3 text-center">
                        <span class="font-weight-bold text-black text-uppercase"><?= $plan->translations->{\Altum\Language::$name}->name ?: $plan->name ?></span>
        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_custom->color ? 'border-top-color: ' . settings()->plan_custom->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3 text-center">
                        <span class="font-weight-bold text-black text-uppercase"><?= settings()->plan_custom->translations->{\Altum\Language::$name}->name ?: settings()->plan_custom->name ?></span>
                    </div>
