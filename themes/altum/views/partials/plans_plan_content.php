...
<div>
    ...
    <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <i class="fas fa-fw fa-sm <?= $data->plan_settings->categories_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <i class="fas fa-fw fa-sm <?= $data->plan_settings->items_limit ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center my-3 <?= $data->plan_settings->ordering_is_enabled ? null : 'text-muted' ?>">
        ...
        <i class="fas fa-fw fa-sm <?= $data->plan_settings->ordering_is_enabled ? 'fa-check text-success' : 'fa-times' ?>"></i>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center my-3 <?= $data->plan_settings->online_payments_is_enabled ? null : 'text-muted' ?>">
        ...
        <i class="fas fa-fw fa-sm <?= $data->plan_settings->online_payments_is_enabled ? 'fa-check text-success' : 'fa-times' ?>"></i>
    </div>
