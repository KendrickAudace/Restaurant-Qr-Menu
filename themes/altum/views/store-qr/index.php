...
<?php endif ?>
   ...
   <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="h4 text-truncate mb-0"><i class="fas fa-fw fa-xs fa-store mr-1"></i> <?= sprintf(l('store_qr.header'), $data->store->name) ?></h1>
            ...
            <div class="row mb-4">
                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                    <button type="button" onclick="window.print()" class="btn btn-block btn-outline-secondary d-print-none">
                        <i class="fas fa-fw fa-sm fa-file-pdf mr-1"></i> <?= l('store_qr.print') ?>
                    </button>
                </div>
