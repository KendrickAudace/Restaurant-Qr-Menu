    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= l('statistics.statistics.utms') ?></h3>

                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('statistics.statistics.utms_help') ?>">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=utm_medium&utm_source=' . $row->utm_source . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><?= $row->utm_source ?></a>
                        </div>
