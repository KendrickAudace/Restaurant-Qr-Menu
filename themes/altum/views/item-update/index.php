...
<?php endif ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="h4 text-truncate mb-0"><i class="fas fa-fw fa-xs fa-burn mr-1"></i> <?= sprintf(l('global.update_x'), $data->item->name) ?></h1>
    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <label for="url"><i class="fas fa-fw fa-sm fa-bolt text-muted mr-1"></i> <?= l('item.input.url') ?></label>
        <div class="mb-3">
        ...
        <div class="form-group">
            <label for="name"><i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('item.input.name') ?></label>
        ...
        <div class="form-group">
            <label for="description"><i class="fas fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('item.input.description') ?></label>
            ...
            <?php if(!empty($data->item->image)): ?>
                <div class="row">
                    <div class="my-2 col-6 col-xl-4">
                        <img src="<?= \Altum\Uploads::get_full_url('item_images') . $data->item->image ?>" class="img-fluid" loading="lazy" />
                    </div>
                </div>
        ...
        <div class="form-group custom-control custom-switch">
            ...
            <label class="custom-control-label" for="is_enabled"><i class="fas fa-fw fa-sm fa-dot-circle text-muted mr-1"></i> <?= l('item.input.is_enabled') ?></label>
