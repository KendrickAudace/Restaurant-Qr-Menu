...
<?php endif ?>
    ...
    <div class="alert alert-secondary mb-4"><?= sprintf(l('domains.input.help'), '<strong>' . (settings()->stores->domains_custom_main_ip ?: $_SERVER['SERVER_ADDR']) . '</strong>', '<strong>' . $host . '</strong>') ?></div>
    ...
    <form action="" method="post" role="form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="custom_index_url" name="custom_index_url" class="form-control" value="<?= $data->domain->custom_index_url ?>" placeholder="<?= l('global.url_placeholder') ?>" />
        ...
        <div class="form-group">
            ...
            <input type="text" id="custom_not_found_url" name="custom_not_found_url" class="form-control" value="<?= $data->domain->custom_not_found_url ?>" placeholder="<?= l('global.url_placeholder') ?>" />
