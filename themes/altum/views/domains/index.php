    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex d-print-none">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('domain-create') ?>" class="btn btn-outline-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->total_domains, $this->user->plan_settings->domains_limit, isset($data->filters) ? !$data->filters->has_applied_filters : true) ?>">
                        <i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('domains.create') ?>
                    </a>
                <?php endif ?>
            </div>
                    ...
                    <?php foreach($data->domains as $row): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap text-muted">
                                <a href="<?= url('dashboard?domain_id=' . $row->domain_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('stores.title') ?>">
                                    <i class="fas fa-fw fa-store text-muted"></i>
                                </a>
                            </td>
