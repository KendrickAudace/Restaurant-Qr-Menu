...
<nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li>
                <?= l('item_extra.breadcrumb') ?><i class="fas fa-fw fa-angle-right"></i>
            </li>
...
<?php endif ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="h4 text-truncate mb-0"><?= sprintf(l('global.update_x'), $data->item_extra->name) ?></h1>
    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="name"><i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('item_extra.input.name') ?></label>
        ...
        <div class="form-group">
            <label for="description"><i class="fas fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('item_extra.input.description') ?></label>
        ...
        <label for="price"><i class="fas fa-fw fa-sm fa-dollar-sign text-muted mr-1"></i> <?= l('item_extra.input.price') ?></label>
        <div class="mb-3">
        ...
        <div class="form-group custom-control custom-switch">
            ...
            <label class="custom-control-label" for="is_enabled"><i class="fas fa-fw fa-sm fa-dot-circle text-muted mr-1"></i> <?= l('item_extra.input.is_enabled') ?></label>
