...
class AdminSettings extends Controller {
    ...
    public function ads() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'header' => $_POST['header'],
                'footer' => $_POST['footer'],
                'header_stores' => $_POST['header_stores'],
                'footer_stores' => $_POST['footer_stores'],
            ]);
    ...
    public function custom() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'head_js_store' => $_POST['head_js_store'],
                'head_css_store' => $_POST['head_css_store'],
                'body_content_store' => $_POST['body_content_store'],
            ]);
    ...
    public function stores() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['menu_image_size_limit'] = $_POST['menu_image_size_limit'] > get_max_upload() || $_POST['menu_image_size_limit'] < 0 ? get_max_upload() : (float) $_POST['menu_image_size_limit'];
            $_POST['item_image_size_limit'] = $_POST['item_image_size_limit'] > get_max_upload() || $_POST['item_image_size_limit'] < 0 ? get_max_upload() : (float) $_POST['item_image_size_limit'];
            ...
            $value = json_encode([
                ...
                'menu_image_size_limit' => $_POST['menu_image_size_limit'],
                'item_image_size_limit' => $_POST['item_image_size_limit'],
            ]);

            $this->update_settings('stores', $value);
        }
    }
