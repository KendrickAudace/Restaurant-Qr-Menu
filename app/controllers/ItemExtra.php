...
class ItemExtra extends Controller {
    ...
    public function delete() {
        ...
        if(!$item_extra = db()->where('user_id', $this->user->user_id)->where('item_extra_id', $item_extra_id)->getOne('items_extras', ['store_id', 'menu_id', 'category_id', 'item_id', 'item_extra_id', 'name'])) {
            redirect('dashboard');
        }
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            /* Clear cache */
            cache()->deleteItemsByTag('store_id=' . $item_extra->store_id);
