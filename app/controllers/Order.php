...
class Order extends Controller {
    ...
    public function complete() {
        ...
        /* Team checks */
        if(\Altum\Teams::is_delegated() && !\Altum\Teams::has_access('update.orders')) {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            /* Clear cache */
            cache()->deleteItemsByTag('store_id=' . $order->store_id);
    ...
    public function delete() {
        ...
        /* Team checks */
        if(\Altum\Teams::is_delegated() && !\Altum\Teams::has_access('delete.orders')) {
            Alerts::add_info(l('global.info_message.team_no_access'));
            redirect('dashboard');
        }
