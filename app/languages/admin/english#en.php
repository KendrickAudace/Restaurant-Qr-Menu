...
return [
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
    ...
    'admin_settings.stores.example_url' => 'Example store page URL',
    'admin_settings.stores.example_url_help' => 'Display example store page button on the homepage. Leave empty to disable.',
    ...
    'admin_settings.stores.branding_help2' => 'You can use the following dynamic variables: <code>{{WEBSITE_TITLE}}</code>, <code>{{URL}}</code>, <code>{{AFFILIATE_URL_TAG}}</code>.',
    ...
    'admin_broadcasts.main.languages' => 'Browser languages',
